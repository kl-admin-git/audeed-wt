...
@section('css')
    <link rel="stylesheet" href="{{ assets_version('/vertical/assets/css/administracion/equipos/main.css') }}">
@endsection

@section('breadcrumb')
    <h3 class="page-title">Equipos</h1>
    @endsection
    ...
    @section('section')
                ...
                <div class="col-lg-12">
                    <div class="page-content-wrapper mb-5 p-0">
                        <div class="container-fluid">
                            <div class="row contenedorEquipos">
                                {{-- CARGADA POR JS --}}
                            </div> <!-- end row -->
        ...
        <!--  MODAL CREAR EQUIPO -->
        <div class="modal fade bs-example-modal-lg" id="crearEquipoPopUp" tabindex="-1" role="dialog"
            aria-labelledby="myLargeModalLabel" aria-hidden="true" data-backdrop="static" data-keyboard="false">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title mt-0">Creación de Equipo</h5>
                        <button type="button" class="close cancelarPopUpEquipo" aria-hidden="true">×</button>
                    </div>
                        ...
                        <div class="col-lg-12">
                            <div class="card m-b-20">
                                <div class="card-body">
                                    ...
                                    <form class="" id="formularioCreacionEquipos" action="#">
                                        <div class="row">

                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    <label>Nombre: <span class="requerido">*</span></label>
                                                    <input type="text" class="form-control nombreEquipoPopUp" required
                                        ...
                                        <div class="form-group m-b-0">
                                            <div class="contenedorBotonesCreacion">
                                                <button type="button"
                                                    class="btn btn-primary waves-effect waves-light crearEquipo"
                                                    accion="0">Crear</button>
                                                <button type="button"
                                                    class="btn btn-secondary waves-effect m-l-5 cancelarPopUpEquipo">Cancelar</button>
                                            </div>
                                        </div>
