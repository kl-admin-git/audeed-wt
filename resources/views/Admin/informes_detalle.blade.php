...
@section('css')
<link rel="stylesheet" href="{{ assets_version('/vertical/assets/css/informes/detalle/main.css') }}">
@endsection

@section('breadcrumb')
<h3 class="page-title">Informe detalle</h1>
@endsection
@section('section')
        ...
        <div class="card m-b-20">
            <div class="card-body">
                <div class="col-lg-12 m-b-30 contenedorTablaEjecutadasInformes">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div>
                                                                <div class="input-group">
                                                                    <input type="text" class="form-control" value="" placeholder="fecha de inicio" id="datepicker-autoclose">
                                                            ...
                                                            <div>
                                                                <div class="input-group">
                                                                    <input type="text" class="form-control" value="" placeholder="fecha de final" id="datepicker-autoclose-end">
                                                                    <div class="input-group-append">
                                                                        <span class="input-group-text"><i class="mdi mdi-calendar" style="color: green"></i></span>
                                                                    </div>
                                                                </div><!-- input-group -->
                    ...
                    <table id="tablaInformesDetalle" class="table table-striped m-b-0">
                        <thead>
                            <!-- CARGADO POR JS -->
                        </thead>
...
<script type="text/javascript" src="{{ assets_version('/vertical/assets/js/informes/detalle/main.js') }}"></script>
