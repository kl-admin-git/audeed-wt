...
@section('css')
<link rel="stylesheet" href="{{ assets_version('/vertical/assets/css/informes/dotacion_higienicas/main.css') }}">
@endsection

@section('breadcrumb')
<h3 class="page-title">Dotación y Prácticas higienicas</h1>
@endsection
@section('section')
            ...
            <div class="card-body">
                <div class="col-lg-12 m-b-30 contenedorTablaEjecutadasInformes">
                    ...
                    <div class="col-lg-12 dev-overflow-100">
                        <table class="table table-striped m-b-0 tableDotacion">
                            <thead>
                                <tr>
                                    <th colspan="5"><b>Fecha:</b> <span class="fechaRealizacion"></span></th>
                                    <th colspan="4"> <b>Calificación: </b>Cumple - No Cumple</th>
                                </tr>
                                <tr>
                                    <th>Área</th>
                                    <th>Empleado</th>
...
<script type="text/javascript" src="{{ assets_version('/vertical/assets/js/informes/dotacion_higienicas/main.js') }}"></script>
@endsection