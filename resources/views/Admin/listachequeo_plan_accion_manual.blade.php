...
@section('css')
<link rel="stylesheet" href="{{ assets_version('/vertical/assets/css/listachequeo/planaccion_manual/main.css') }}">
@endsection

@section('breadcrumb')
<h3 class="page-title">Plan de acción manual</h1>
@endsection
@php
    $clase="";
    if(!is_null($filtrar))
                        ...
                        <div class="row m-b-10">
                            <div class="col-lg-12">
                                <div class="contenedorBuscador">
                                    ...
                                    <form action="{{url('/listachequeo/planaccion/manual/descargar-excel')}}" method="POST" style="display: none;" id="descargar-excel-planAccion">
                                        @csrf
...
<script type="text/javascript" src="{{ assets_version('/vertical/assets/js/listachequeo/planaccion_manual/main.js') }}"></script>
@endsection