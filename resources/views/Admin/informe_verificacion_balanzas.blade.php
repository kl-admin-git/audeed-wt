...
@section('css')
<link rel="stylesheet" href="{{ assets_version('/vertical/assets/css/informes/verificacion_balanzas/main.css') }}">
@endsection

@section('breadcrumb')
<h3 class="page-title">Verificación de balanzas</h1>
@endsection
@section('section')
            ...
            <div class="card-body">
                <div class="col-lg-12 m-b-30 contenedorTablaEjecutadasInformes">
                    ...
                    <div class="col-lg-12 dev-overflow-100">
                        <table class="table table-striped m-b-0 tableVerificacion">
                            <thead>
                                <tr>
                                    <th colspan="6" style="background-color: #003366; color:#fff">VERIFICACIÓN DE BALANZAS</th>
                                </tr>
                                <tr>
                                    <th colspan="1"><b>Fecha:</b></th>
                                    <th colspan="2"><span class="fechaRealizacion"></span></th>
                                    <th colspan="1"><b>Diligenciado:</b></th>
                                    <th colspan="2"><span class="diligenciado"></span></th>
                                </tr>
                                ...
                                <tr>
                                    <th style="background-color: #003366; color:#fff">Balanza</th>
                                    <th style="background-color: #003366; color:#fff">Activo</th>
                                    <th style="background-color: #003366; color:#fff">Masa patrón</th>
                                    <th style="background-color: #003366; color:#fff">Desviación</th>
                                    <th colspan="2" style="background-color: #003366; color:#fff">Observaciones</th>
                                </tr>
                            </thead>
                            <tbody>
                                {{-- CARGADO POR JS --}}
...
<script type="text/javascript" src="{{ assets_version('/vertical/assets/js/informes/verificacion_balanzas/main.js') }}"></script>
@endsection