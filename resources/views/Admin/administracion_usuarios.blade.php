...
@endphp
@section('css')
<link rel="stylesheet" href="{{ assets_version('/vertical/assets/css/administracion/usuarios/main.css') }}">
@endsection
...
<div class="row datosUsuario" idCuentaPrincipal="{{ auth()->user()->cuenta_principal_id }}" idUsuario="{{ auth()->user()->id }}">
    <div class="col-12">
        <div class="col-lg-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="m-t-10">
                                                <input type="password" id="confirmPassword" class="form-control" required
                                                       data-parsley-equalto="#passwordUsuario" data-parsley-minlength="8" data-parsley-minlength-message = "El valor es muy corto. Debería tener 8 caracteres o más."
...
@section('script')
<script type="text/javascript" src="{{ assets_version('/vertical/assets/js/administracion/usuarios/main.js') }}"></script>
@endsection