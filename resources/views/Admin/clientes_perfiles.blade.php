...
@section('css')
<link rel="stylesheet" href="{{ assets_version('/vertical/assets/css/clientes/perfiles/main.css') }}">
@endsection
...
@section('script')
<script type="text/javascript" src="{{ assets_version('/vertical/assets/js/clientes/perfiles/main.js') }}"></script>
@endsection