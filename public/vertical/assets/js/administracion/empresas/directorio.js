...
let paginacion = 1;
let arrayFiltros = {};
let idEmpresa = $('.datosUsuario').attr('idEmpresa');
...
function IniciarVista(activarCargando = false) 
{
    ...
    $.ajax({
        type: 'POST',
        url: '/administracion/empresas/directorio/consultaUsuarios',
        data: 
        {
...
function CargarUsuarios() 
{
    ...
    $.ajax({
        type: 'POST',
        url: '/administracion/empresas/directorio/consultaUsuarioScroll',
        data: 
        {
            _token: $('meta[name="csrf-token"]').attr('content'),
            idCuentaPrincipal:idCuentaPrincipal,
                                ...
                                <div class="card-body">
                                    <div class="media">
                                        ...
                                        <div class="media-body contenedorPrincipal">
                                            ...
                                            <p class="text-muted m-b-5 ellipseText"><span class="mdi mdi-email-outline" data-toggle="tooltip" data-placement="left" title="Correo"></span> ${correo}</p>
                                        ...
                                        <div class="contenedorGeneral">
                                            <div class="col-lg-12 contenedorSubtitulos">
                                                ...
                                                <div class="contenedorPassword">
                                                    <span class="ellipseText hidden" style="width:50%;" > <i data-toggle="tooltip" data-placement="left" title="Usuario" class="mdi mdi-account"></i>${(usuario == undefined ? "Sin usuario" : usuario)}</span>
    ...
    if (form.parsley().isValid())
    {
        ...
        if($(this).attr('accion') == 0) // CREAR
        {
            ...
            $.ajax({
                ...
                type: 'POST',
                url: '/administracion/empresas/directorio/crearUsuario',
                data: formData,
                cache: false,
                processData: false, 
                contentType: false, 
        ...
        else if($(this).attr('accion') == 1) // EDITAR
        {
            ...
            $.ajax({
                ...
                type: 'POST',
                url: '/administracion/empresas/directorio/editarUsuario',
                data: formData,
                cache: false,
                processData: false, 
                contentType: false,
...
function OnClickEliminarUsuario(control) 
{
    ...
    Swal.fire({
        ...
        if(resultado.dismiss == 'cancel')
            ...
            $.ajax({
                type: 'POST',
                url: '/administracion/empresas/directorio/eliminarUsuario',
                data: 
                {
                    _token: $('meta[name="csrf-token"]').attr('content'),
                    idUsuario:idUsuario
...
function OnClickEditarUsuario(control) 
{
    ...
    $.ajax({
        type: 'POST',
        url: '/administracion/empresas/directorio/consultarUsuarioEdicion',
        data: 
        {
            _token: $('meta[name="csrf-token"]').attr('content'),
            idUsuario:idUsuario
...
function OnClickCambiarEstado(control) 
{
    ...
    $.ajax({
        type: 'POST',
        url: '/administracion/empresas/directorio/actualizarEstadoUsuario',
        data: 
        {
            _token: $('meta[name="csrf-token"]').attr('content'),
            idUsuario:idUsuario,
